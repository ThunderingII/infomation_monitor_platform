...
if __name__ == '__main__':
    ...
    if pfs is None:
        ...
        login_response = pfs.post('https://accounts.douban.com/login')
        file_util.write(login_response.text, 'douban.html')
        login_data = data_util.pre_process(login_response, data_util.ResponseType.html)
